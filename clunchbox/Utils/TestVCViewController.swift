...
//  clunchbox
//
//  Created by Macintosh on 06/01/2019.
//  Copyright © 2019 Eléa Reggiani. All rights reserved.
//
...
class TestVCViewController: UIViewController {
    ...
    // Example of how to create an event programatically :
    func createEvent(){
...
extension TestVCViewController: EKEventViewDelegate {
    func eventViewController(_ controller: EKEventViewController, didCompleteWith action: EKEventViewAction) {
        dismiss(animated: true, completion: nil)
    }
}

extension TestVCViewController: EKEventEditViewDelegate, UINavigationControllerDelegate {
